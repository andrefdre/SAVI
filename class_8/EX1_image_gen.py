...
def main():
    ...
    cv2.imwrite('./machu_pichu/query_warped.png',q_image_warped)
    cv2.imwrite('./machu_pichu/target.png',q_machu_pichu)
    cv2.imwrite('./machu_pichu/query_stitched.png',q_stich_gui)
